...
- "dataset": |-
  ...
  - "field": |-
      reference
    "description": |-
      the <a href="#reference">reference</a> for the listed building
    "guidance": |
  ...
  - "field": |-
      name
    "description": |-
      the name of the listed building
    "guidance": |
  ...
  - "field": |-
      listed-building
    "description": |-
      the Historic England identifier for the listed building, for example <a href="https://historicengland.org.uk/listing/the-list/list-entry/1024710" class="govuk-link">1024710</a>
    "guidance": |
  ...
  - "field": |-
      organisation
    "description": |-
      the organisation responsible for the listed building
  - "field": |-
      entry-date
    "description": |-
