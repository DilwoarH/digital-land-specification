...
- dataset: article-4-direction
  ...
  - description: the URL of the web page where you can find the document for the article
      4 direction
    field: document-url
  ...
  - description: the date the validity of the record starts
    field: start-date
    guidance: 'The date that the article 4 direction came into force, written in `YYYY-MM-DD`
      format.
...
- dataset: article-4-direction-area
  ...
  - dataset: permitted-development-right
    description: a list of one or more <a href="#reference">reference</a> values for
      <a href="article-4-direction-rule-dataset">permitted development right</a> entries,
  ...
  - description: unique property reference numbers for any addressable properties,
    ...
    guidance: 'If the geometry is the boundary of a building, you can provide the
      ...
      '
  - description: the addresses of any properties reference. The addresses should be
      written as address-text (a single line separated by commas). To write multiple
    ...
    guidance: 'If the geometry is the boundary of a building, you can provide the
      ...
      '
  - description: the boundary of the area covered by the article 4 direction in WKT
      format
    field: geometry
    guidance: "The boundary for the article 4 direction area as a single polygon or\
